...
include_once("./new_lib/core_nastr.php");

include_once("./new_lib/calc_deng2.php");
...
for($loop= 0; $loop <1; $loop++)
{
  ...
  //-------------------//
  //echo "<hr>\n";
  $all_deng= calc_deng(3, $prog_min->all_people, $strt, $stp , $price, $lgot, $nastr);
