...
// var $sred_month_dohod_sem; //среднемес€чный доход семьи//
...
///////////////////////////////////////////////////////////////////////////////////////////
function sred_mec_doh_people($id_people) //среднемес€чный доход каждого члена семьи//
	{
	  $query= "SELECT * FROM dohod WHERE id_people= '$id_people'";
	  $this->connect_db();
      $result= mysql_query($query) or die (mysql_error());
...
function sred_m_sov_doh($id_home)// —реднемес€чный совокупный доход//
	{
...
function sred_dush_doh_($id_home)
	{
...
//echo "<hr>\n";	  
//	echo $this->sred_dush_doh;  //—реднедушевой доход семьи//
//	echo "<br>\n";
//	echo $this->sov_dohod_semi; //—овокупный доход семьи//	  
//echo "<hr>\n";
	}
