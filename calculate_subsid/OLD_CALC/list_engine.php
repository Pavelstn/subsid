...
//	   $kldr1= new kladr("kladr");
// 	   $find_by->set_value("1");
// 	   //$rows= "house.id_home, street.name, house.nomer_doma, house.nomer_korpusa, house.nomer_kvartiri, people.familia";
// 	   //$tables= "house, street, people, house_env";
...
<?
$query= "SELECT * FROM zayavki WHERE sost_vipl= '2'";
