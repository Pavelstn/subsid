...
class db_table2 extends database_work
{
  ...
  function show_checkbox($row, $ii)
  	{
	    ...
	    if($ii== 0)
	    {
		  ...
		  echo $this->repalase_date($row[$ii])."&nbsp;";
		}
		//else {echo $row[$ii]."&nbsp;";}
...
//////////////////////////////////////////////////////////////////////////////////////
		...
		$target="";
		if($this->target_top) $target="TARGET=\"_top\""; 
	if($this->edit_flag) { echo "   <td><a href=\"".$this->edit_path."?id_row=".$this->edit_row."&edit\" ".$target.">редактировать</a></td>\n";} //при включенном флаге редактирования//
		echo "</tr>\n";
		}
//////////подвал////////////////////////////
	echo "<tr>\n";
